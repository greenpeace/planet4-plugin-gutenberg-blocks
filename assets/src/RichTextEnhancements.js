export const addSubAndSuperscript = function( wp ) {
  ...
  /* Superscript icon */
  const superscriptIcon = wp.element.createElement(
    'svg',
    {
      width: 20,
      height: 20,
   ...
   * @param props
   */
  const SubscriptButton = function( props ) {
   ...
   * @param props
   */
  const SuperscriptButton = function( props ) {
    return wp.element.createElement( wp.editor.RichTextToolbarButton, {
