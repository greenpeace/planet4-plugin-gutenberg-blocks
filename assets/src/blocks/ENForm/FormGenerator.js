...
const Input = ( props ) => {
  ...
  return ( ( returnField ) => {
    ...
    case 'text':
    case 'email':
      return <TextInput { ...{ returnField, onInputChange, onBlur, errors, is_side_style } } />;
    case 'checkbox':
      return <CheckboxInput { ...{ returnField, onInputChange, onBlur, index, dependent_field, errors, is_side_style } } />;
    case 'radio':
      return <RadioInput { ...{ returnField, onInputChange, onBlur, errors, is_side_style } } />;
    case 'country':
      return <CountryInput { ...{ returnField, onInputChange, onBlur, errors, is_side_style } } />;
    case 'position':
      return <PositionInput { ...{ returnField, onInputChange, onBlur, errors, is_side_style } } />;
    case 'hidden':
      return <HiddenInput { ...{ returnField } } />;
    default:
...
const RadioInput = ( { field, onInputChange, onBlur, errors } ) => {
  ...
  return (
    <div className="en__field">
      ...
      { inputs }
      { has_error &&
			<div className="invalid-feedback">{ errors && errors[ field.id ] }</div>
      }
    </div>
  );
};
