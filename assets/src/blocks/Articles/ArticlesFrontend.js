...
export const ArticlesFrontend = ( props ) => {
  ...
  // Change className to postClassName to avoid {'className' is already declared in the upper scope.eslintno-shadow} error.
  const postIdClass = [ ...document.body.classList ].find( ( postClassName ) => /^postid-\d+$/.test( postClassName ) );
